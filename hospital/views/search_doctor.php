				...
				<div class="table-responsive">
					<table class="table text-center table-hover">
					  ...
					  <?php
						...
						<div class="modal fade" id="delete<?php echo $id; ?>" tabindex="-1" aria-labelledby="doctorModalLabel2" aria-hidden="true">
						  <div class="modal-dialog">
						    <div class="modal-content">

						      <div class="modal-header">
						        <h5 class="modal-title" id="doctorModalLabel2">Do you want to Delete <?php echo $f_name.' '.$l_name; ?>?</h5>
