			...
			<div class="pb-5">
				<div class="container d-flex justify-content-center card">
					<div class="card-header">
						<h4 class="text-center">E D I T &nbsp; &nbsp; P A T I E N T</h4>
					</div>
					<div class="card-body">
						<form method="POST" class="row" action="../controllers/patient_Controller.php" enctype="multipart/form-data">

							<div class="col-md-6 pb-1">
							    <label for="f_name" class="form-label">First Name</label>
							    <input type="text" name="f_name" class="form-control" id="f_name" value="<?php echo $patient['f_name'];?>" autocomplete="off" onkeyup="checkFirstName()" onblur="checkFirstName()">
							    <span style="color:red" id="err_f_name"><?php echo $err_f_name;?></span>
							</div>

							<div class="col-md-6 pb-1">
							    <label for="l_name" class="form-label">Last Name</label>
							    <input type="text" name="l_name" class="form-control" id="l_name" value="<?php echo $patient['l_name']?>" autocomplete="off" onkeyup="checkLastName()" onblur="checkLastName()">
							...
							<div class="col-md-6 pb-1">
							    ...
							    <input type="text" name="mobile_no" class="form-control" id="phone_no" value="<?php echo $patient['mobile_no'];?>" autocomplete="off" onkeyup="checkNumber()" onblur="checkNumber()">
							    <span style="color:red" id="err_phone_no"><?php echo $err_mobile_no;?></span>
							</div>

							<div class="col-md-6 pb-1">
							    <label for="b_date" class="form-label">Birth Date</label>
							    <input type="date" name="b_date" class="form-control" id="b_date" value="<?php echo $patient['birth_date'];?>" onkeyup="checkBirthDate()" onblur="checkBirthDate()">
							    <span style="color:red" id="err_b_date"><?php echo $err_b_date; ?></span>
							</div>

							<div class="col-md-6 pb-1">
							    <label for="email" class="form-label">Email</label>
							    <input type="text" name="email" class="form-control" id="email" value="<?php echo $patient['email'];?>" autocomplete="off" onkeyup="checkEmail()" onblur="checkEmail()">
							...
							<div class="col-md-6 pb-1">
							    ...
							    <select id="status" name="status" class="form-select" onkeyup="checkStatus()" onblur="checkStatus()">
				                    <option <?php if($patient['status'] == 1 ) echo 'selected'; ?> value="1">Active</option>
				                    <option <?php if($patient['status'] == 2 ) echo 'selected'; ?> value="2">In-Active</option>
							    </select>
								<span style="color:red" id="err_status"><?php echo $err_status;?></span>
							</div>

							<div class="col-md-6">
								<img style="height: 100px; width: 100px;" src="<?php echo $patient['picture'];?>">
							</div>

							<div class="col-md-6 pb-1">
							    <label for="address" class="form-label">Address</label>
							    <textarea name="address" class="form-control h-25" id="address" autocomplete="off" onkeyup="checkAddress()" onblur="checkAddress()"><?php echo $patient['address'];?></textarea>
							...
							<div class="col-12 pt-2 pb-1">
							    <input type="submit" name="edit_patient" class="btn btn-primary" value="Save Changes">
							</div>
