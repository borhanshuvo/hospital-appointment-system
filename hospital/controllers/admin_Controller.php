<?php
	...
	if(isset($_GET['req']) && $_GET['req'] == 'add_adm')
	{
		insertAdmin();
	}
	...
	function insertAdmin()
	{
		...
		$name=($f_name.' '.$l_name);
		$user_type='admin';
		$query="INSERT INTO add_admin VALUEs(NULL,'$f_name','$l_name','$gender','$blood_type','$mobile_no','$birth_date','$email','$present_address','$permanent_address','$city','$target_file')";
	...
	function editAdmin()
	{
		...
		$query="UPDATE add_admin SET f_name='$f_name',l_name='$l_name',gender='$gender',blood_type='$blood_type',mobile_no='$mobile_no',birth_date='$birth_date',email='$email',present_address='$present_address',permanent_address='$permanent_address',city='$city',picture='$target_file' WHERE id=$id";
